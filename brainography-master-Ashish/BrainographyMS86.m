function H = BrainographyMS86(startupstruct)

%startupstruct fields:
%baseStruct the Brainography struct filename created for this run, which is
%'brainography-master/sample_files/ashish_86_region_base.mat'
%plottype: 'surface' or 'glassbrain'
%nodevalues: 1x86 size of nodes
%nodescale 'Small','Normal','Large','XL'
%pipescale (same)
%nodeflag 1/0
%pipeflag 1/0, must supply connectivity
%connectivity: 86x86 symmetric; values > 1 determine pipe radius
%surfacevalues: 1x86 for opaque surface plot
